...
@ -I/home/maximilian/projects/git-clean/ev3sources/extra/linux-03.20.00.13/arch/arm/include
@ -Iinclude -Iarch/arm/mach-davinci/include -iprefix
@ /opt/CodeSourcery/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.3/ -isysroot
@ /opt/CodeSourcery/bin/../arm-none-linux-gnueabi/libc -D__KERNEL__
@ -D__LINUX_ARM_ARCH__=5 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(bounds) -DKBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem
@ /opt/CodeSourcery/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.3/include
